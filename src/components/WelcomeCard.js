               ...
               <div style={{ width: '70%', marginTop: 50 }}>
                  ...
                  {register && (
                     <div style={{ fontWeight: 400, fontSize: 14, marginTop: 9, color: '#CCCCCC', display: 'flex', justifyContent: 'center' }}>
                        ...
                        <div style={{ marginLeft: 5, color: '#43568E', fontStyle: 'italic', textDecoration: 'underline', cursor: 'pointer' }}>
                           Register
                        </div>
                     </div>
                  )}
                  ...
                  {login && (
                     <div style={{ fontWeight: 400, fontSize: 14, marginTop: 9, color: '#CCCCCC', display: 'flex', justifyContent: 'center' }}>
                        ...
                        <div
                           style={{ marginLeft: 5, color: '#43568E', fontStyle: 'italic', textDecoration: 'underline', cursor: 'pointer' }}
